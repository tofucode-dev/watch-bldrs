...
const inputBase =
  "w-full rounded-sm border bg-background px-3 py-2 pl-10 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 transition-colors";
