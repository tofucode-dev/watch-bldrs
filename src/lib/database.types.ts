    ...
    Tables: {
      ...
      builds: {
        Row: {
          ...
          created_at: string
          dial_colour: Database["public"]["Enums"]["dial_colour"] | null
          hands_style: Database["public"]["Enums"]["hands_style"] | null
          id: string
          main_image_path: string | null
          movement: Database["public"]["Enums"]["movement"] | null
          name: string | null
          published_at: string | null
          status: Database["public"]["Enums"]["build_status"]
          story: string | null
          strap_type: Database["public"]["Enums"]["strap_type"] | null
          updated_at: string
          watch_style: Database["public"]["Enums"]["watch_style"] | null
        }
        Insert: {
          author_id: string
          case_size_mm?: number | null
