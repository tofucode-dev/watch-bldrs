...
flowchart TB
  ...
  class F01,F02,F03,F04,F05,S02,S03 done
  class S01 ready
  class S04 north
```
...
| F-02 | authoring-form-components | Add every UI component the authoring form needs to the shared UI library | no | Already `done` |
| F-03 | photo-upload-component | Photo-upload component and its upload logic for one main photo | no | Already `done` |
| S-01 | sign-in-and-session | Register, log in, and log out without extra profile fields | yes | Parallel with remaining proposed work; sign-in method is a non-blocking unknown |
| S-02 | create-draft-build | Create a private draft build | no | Already `done` |
| S-03 | publish-draft-build | Publish a draft the author owns | no | Already `done` |
| F-04 | listing-ui-components | Add listing Cards, Labels, Badges, Tags, and Buttons to the shared UI library | no | Already `done` |
...
| F-06 | home-page-components | Add Nav bar, Hero, Quick Filters, and home-page sections to the shared UI library | no | Needs F-04 and F-05 (both done) |
